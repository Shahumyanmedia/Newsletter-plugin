...
define('SH_NEWSLETTER_DIR', plugin_dir_url(__FILE__));
/*plugin start*/
...
register_activation_hook(__FILE__, 'sh_newsletter_activation');
register_deactivation_hook(__FILE__, 'sh_newsletter_deactivation');
